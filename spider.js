/**
 * Spider - Araña orgánica con IK mejorado
 * Diseño minimalista con curvas Bézier
 */
...
class Spider {
    ...
    /**
     * IK mejorado con articulaciones naturales
     */
    solveIK(leg, targetX, targetY) {
        ...
        // Ángulo del primer segmento con doblez natural
        ...
        // Tercer segmento apunta al objetivo
    ...
    updateLegStepping(leg) {
        ...
        const baseX = this.x + Math.cos(leg.baseAngle) * restDistance;
        const baseY = this.y + Math.sin(leg.baseAngle) * restDistance;

        leg.targetX = baseX;
        leg.targetY = baseY;

        if (leg.isLifted) {
            leg.liftProgress += 0.12;
            ...
            const liftHeight = Math.sin(easeT * Math.PI) * 15;
