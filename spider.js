...
class Spider {
    ...
    updateLegNatural(leg) {
        ...
        if (leg.isLifted) {
            ...
            const liftVariation = 1 + (leg.index % 2) * 0.15;
            const liftHeight = Math.sin(easeT * Math.PI) * 10 * liftVariation;
            ...
            if (dist > 22) {
                ...
                const adjustSpeed = 0.06 + (leg.index % 3) * 0.015;
